...
@Component({
  selector: 'app-butchers-signup',
  templateUrl: './butchers-signup.component.html',
  styleUrls: ['./butchers-signup.component.scss'],
})
export class ButchersSignupComponent {
  sigupForm: any;
