...
@Component({
  selector: 'app-signup-verify-farmer',
  templateUrl: './signup-verify-farmer.component.html',
  styleUrls: ['./signup-verify-farmer.component.scss'],
})
export class SignupVerifyFarmerComponent {
  sigupForm: any;
  verificationNo: any;
  constructor(
  ...
  verificationClick(signup) {
    ...
    this.signupService.validateUser(userInfo).subscribe(
      (res) => {
